...
export type SequentialThinkingServerFactoryResponse = {
  server: McpServer;
  cleanup: (sessionId?: string) => void;
};

export const createServer = (): SequentialThinkingServerFactoryResponse => {
...
11. Only set nextThoughtNeeded to false when truly done and a satisfactory answer is reached`,
  ...
  return {
    server,
    cleanup: () => {
      // No background processes to clean up currently.
    },
  };
};
