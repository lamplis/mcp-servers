...
These servers are the **default tools** for knowledge, memory, cross-project files, local vectors, and hard reasoning. Do not treat this file as a catalog. Follow the routing table and recipes.
